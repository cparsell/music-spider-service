...
import { sendAppsScriptEmail } from "./appsScriptNotifier.js";
...
/**
 * Sends an HTML email - via the Gmail API using the connected OAuth
 * account, or via a user-deployed Apps Script webapp, depending on
 * googleIntegrationMode in Settings.
