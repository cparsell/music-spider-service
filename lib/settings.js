...
const DEFAULT_SETTINGS = {
  ...
  // Calendar-only alternative to the two modes above - a GCP service
  // account the user shares a calendar with. Takes precedence over
  // googleIntegrationMode for calendar events when enabled.
