...
- **Ticketmaster** —
  - Requires a free [Ticketmaster API key](https://developer.ticketmaster.com/). Create an account then create an "app". **NOTE: the `Redirect URI` is unnecessary. You can set it to `http://127.0.0.1/` if required to get the API key**
  - plus your location as [Lat/Long](https://www.latlong.net/) and a search `Radius` (in miles or km).
