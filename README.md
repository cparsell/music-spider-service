...
- Email (requires OAuth or a [webhook](https://github.com/cparsell/music-spider-service#setting-up-the-apps-script-webhook))
- Calendar (requires OAuth or a [webhook](https://github.com/cparsell/music-spider-service#setting-up-the-apps-script-webhook))

## Running it

- [Set up using Docker Compose](https://github.com/cparsell/music-spider-service/Setup-DockerCompose.md)
- [Set on Unraid](https://github.com/cparsell/music-spider-service/Setup-Unraid.md)
...
- **Email** and/or **Google Calendar** — enable "Send a weekly email digest" and/or "Add newly found events to Google Calendar" under **Google (Email & Calendar)**. Pick one of two ways to let Music Spider actually talk to Google:
  ...
  - **Apps Script Webhook** — send email/calendar actions through a small script you deploy yourself instead. No OAuth client, redirect URI, or HTTPS needed on Music Spider's end. See [Setting up the Apps Script webhook](https://github.com/cparsell/music-spider-service/Setup-AppsScriptWebhookHandler.md).
...
The [Apps Script webhook script](https://github.com/cparsell/music-spider-service/Setup-AppsScriptWebhookHandler.md) was set up as an alternative to the OAuth method.
